...
export default function AboutPage() {
  return (
    <div className="about-page">
      <SEO
        title="Our Story"
        description="Learn about Little Joy Play — our mission to spark joy in every child through play-based, child-led learning across multiple locations in Singapore."
        path="/about"
      />
      ...
      <section className="about-approach">
        <div className="container about-approach__inner">
          <div>
            ...
            <Link to="/services" className="btn btn-primary" style={{ marginTop: 28 }}>Explore our programmes</Link>
          </div>
